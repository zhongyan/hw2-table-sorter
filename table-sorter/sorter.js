...
getAllTables.prototype.makeAllTablesSortable = function(){
			...
			for (var j = 0; j < thLength; j++) {
				...
				this.originalThead[j].onclick = function(){
					...
					if (this.getAttribute('data-sort') == 'descend') {
						...
						sort.selectSort(table, offset, true);
					...
					//ascend
						...
						sort.selectSort(table, offset, false);
...
getAllTables.prototype.selectSort = function(table, offset, way){
